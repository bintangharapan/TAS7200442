                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                 ...
                                 <td>{{$d -> pakar}}</td>
                                 <td>
                                     <a href="" class="btn btn-ouline-info" style="color:blue"><i class="bi bi-pencil"></i></a>
                                     <a href="/dosen/deletedosen/{{ $d-> id}}" class="btn btn-ouline-danger" style="color:red"><i class="bi bi-x-square"></i></a>
                                 </td>
                            </tr>
                            @endforeach
                        </tbody>
